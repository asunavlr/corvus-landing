  ...
  return (
    <section className="section feedback" id="feedback">
      <div className="shell feedback__layout">
        <motion.div className="feedback__intro" variants={stagger()} {...inViewSoft}>
          <motion.p className="eyebrow" variants={riseSmall}>{text.eyebrow}</motion.p>
          <motion.h2 className="h2" variants={rise}>{text.title}</motion.h2>
          <motion.p className="lede" variants={rise}>{text.lede}</motion.p>
          <motion.a className="feedback__public mono" href="https://github.com/asunavlr/corvus-trial/issues" target="_blank" rel="noreferrer" variants={rise}>
            {text.publicLink} ↗
          </motion.a>
        </motion.div>

        <motion.form className="feedback__form" onSubmit={submit} variants={rise} {...inViewSoft}>
